                        ...
                        <div className="detail_body_article">
                            <div className="detail_article">
                                <div className="detail_article_image">
                                    <img src={require("../../img/image.jpg")} alt="imageInfosMeteoDetail" className="view"/>
                                </div>
                                <div className="detail_article_texte">
                                    <div className="detail_article_titre">
                                        <h2 className="detail_article_titre2">{infosMeteoDetail[this.props.match.params.id].title}</h2>
                                    </div>
                                    <div className="detail_article_content">
                                        <p className="detail_article_content2">{infosMeteoDetail[this.props.match.params.id].content}</p>
                                    </div>
                                </div>
                                <div className="btns">
